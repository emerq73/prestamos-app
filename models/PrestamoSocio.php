...
class PrestamoSocio
{
    ...
    {
        $sql = "INSERT INTO prestamo_socios (prestamo_id, socio_id, aporte, porcentaje, porcentaje_interes) VALUES (:prestamo_id, :socio_id, :aporte, :porcentaje, :porcentaje_interes)";
