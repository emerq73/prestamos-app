<div class="mb-4">
    <h3 class="fw-bold"><i class="bi bi-file-earmark-bar-graph me-2"></i>Reporte General de Préstamos</h3>
    <p class="text-muted">Seleccione el rango de fechas para generar el listado de préstamos.</p>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="../reportes/reporte_general_prestamos_pdf.php" method="GET" target="_blank">
                    <div class="mb-3">
